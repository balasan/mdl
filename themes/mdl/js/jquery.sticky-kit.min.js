...
(function() {
  ...
  $.fn.stick_in_parent = function(opts) {
    var elm, inner_scrolling, offset_top, offset_bottom, parent_selector, sticky_class, _fn, _i, _len;
    if (opts == null) {
      opts = {};
    }
    sticky_class = opts.sticky_class, inner_scrolling = opts.inner_scrolling, parent_selector = opts.parent, offset_top = opts.offset_top, offset_bottom=opts.offset_bottom;
    if (offset_top == null) {
      offset_top = 0;
    }
    ...
    _fn = function(elm, padding_bottom, parent_top, parent_height, top, height, el_float) {
      ...
      tick = function() {
        ...
        if (win.scrollTop() + win.height() > $('body').height())
          return;
        ...
        if (fixed) {
          ...
          if (inner_scrolling) {
            ...
            if (height + offset_bottom + offset_top > win_height) {
              if (!bottomed) {
                offset -= delta;
